    ...
    <section className="relative bg-[#050506] py-24 md:py-32 font-['Inter'] overflow-hidden border-b border-white/[0.06]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex items-center justify-center space-x-4 text-sm font-medium">
          <button className="px-6 py-3 bg-[#5E6AD2] hover:bg-[#6872D9] text-white rounded-lg shadow-[0_0_25px_rgba(94,106,210,0.4)] transition-all flex items-center space-x-2 cursor-pointer">
            <span>Explore Design System</span>
            <ArrowRight size={16} />
          </button>
          <button className="px-6 py-3 bg-white/[0.08] hover:bg-white/[0.12] text-white border border-white/20 rounded-lg transition-all cursor-pointer">
            View Documentation
          </button>
        </div>
      </div>
