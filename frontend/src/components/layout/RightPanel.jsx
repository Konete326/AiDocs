...
const CommunityCard = () => (
  <GlassCard className="rounded-2xl p-5 w-full lg:w-60 border-l border-t border-white/5">
...
const FeatureCards = () => (
  <div className="mt-auto space-y-4 lg:space-y-6 w-full">
    <div className="flex flex-col sm:flex-row gap-4">
      <GlassCard className="rounded-3xl p-6 flex-1 flex flex-col items-center text-center">
    ...
    <GlassCard className="rounded-[2.5rem] p-5 flex gap-5 items-center border border-white/5">
      ...
      <button className="liquid-glass rounded-full w-12 h-12 flex items-center justify-center text-white/80 ml-auto cursor-pointer hover:text-white transition-all text-2xl font-light">
        +
      </button>
    </GlassCard>
  </div>
