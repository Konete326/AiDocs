...
const ProfileInfoLinks = ({ user, subscription, memberSince }) => {
  ...
  return (
    <div className="mt-8 w-full space-y-3">
      {links.map((link, i) => (
        <div key={i} className="liquid-glass no-hover rounded-2xl px-4 py-3 flex items-center justify-between transition-all hover:bg-white/[0.02] cursor-default group">
