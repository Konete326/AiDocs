...
const Login = () => {
  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-md liquid-glass-strong rounded-2xl md:rounded-3xl p-6 md:p-12 scale-[0.9] sm:scale-100 origin-top">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-2xl md:text-3xl font-medium text-white tracking-tight mt-3 md:mt-6 text-center">Welcome back</h1>
          <p className="text-xs md:text-sm text-white/60 mt-1">Sign in to continue building</p>
        </div>
        <form onSubmit={handleSubmit} className="mt-5 md:mt-8 space-y-3 md:space-y-4">
